...
MainComponent::MainComponent()
{
    ...
    libraryPanel = std::make_unique<LibraryComponent>();
    ...
    {
        hideUtilityPanels();
        statusLabel.setText("Mixer view active", juce::dontSendNotification);
    };
...
void MainComponent::hideUtilityPanels()
{
    libraryPanel->setVisible(false);
    settingsPanel->setVisible(false);
}

void MainComponent::showLibraryPanel()
{
    hideUtilityPanels();
    libraryPanel->setVisible(true);
    settingsPanel->setVisible(false);
    statusLabel.setText("Library panel active", juce::dontSendNotification);
}
...
void MainComponent::showSettingsPanel()
{
    ...
    libraryPanel->setVisible(false);
    statusLabel.setText("Settings panel active", juce::dontSendNotification);
}
...
void MainComponent::resized()
{
    ...
    if (libraryPanel->isVisible())
        libraryPanel->setBounds(content.reduced(8));

    if (settingsPanel->isVisible())
        settingsPanel->setBounds(content.reduced(8));
